    ...
    <>
      ...
      <section className="pt-8 pb-12 bg-gradient-to-br from-white via-indigo-50 to-fuchsia-50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-8 text-center text-indigo-700">Filtrar por Categoría</h2>
      ...
      <section id="gallery" className="pt-16 pb-24 bg-gradient-to-br from-fuchsia-50 via-indigo-50 to-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {filteredArtworks.length > 0 ? (
              ...
              <div className="col-span-full text-center text-gray-500 text-xl">No hay obras para esta categoría :(</div>
            )}
          </div>
        </div>
      </section>
